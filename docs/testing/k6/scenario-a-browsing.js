// AlbaSambosa — K6 Scenario A: Browsing (50 VU, 3 minutes)
// Target: p95 < 500ms (cached), error < 1%
// Simulates 50 concurrent users browsing catalog and product detail pages.
//
// Run: k6 run docs/testing/k6/scenario-a-browsing.js
//
// Prerequisites:
//   - App running at http://localhost:8000
//   - Database seeded (php artisan db:seed)
//   - At least 5 products in the catalog
